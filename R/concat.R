#' Concatenate LD_pvalues object
#'
#' @param ld_pvalues list of elements of class `LD_pvalues`.
#'
#' @return Object of class `LD_pvalues`
#' @export
...
concat_ld_pvalues <- function(this, other) {
  if (!inherits(this, "LD_pvalues") || !inherits(other, "LD_pvalues")) {
    stop("Can concatenate only elements of class `LD_pvalues`")
  }
